...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      check_in_booking: {
        Args: { p_checked_in_by?: string; p_booking_id: string }
        Returns: boolean
      }
      ...
      get_restaurant_status: {
        Args: { p_restaurant_id: string; p_check_time?: string }
        Returns: {
          close_time: string
          reason: string
          is_open: boolean
      ...
      st_expand: {
        Args:
          ...
          | { dz?: number; geom: unknown; dm?: number; dx: number; dy: number }
        Returns: unknown
      }
      st_exteriorring: {
        Args: { "": unknown }
      ...
      st_hexagon: {
        Args: { cell_j: number; cell_i: number; size: number; origin?: unknown }
        Returns: unknown
      }
      st_hexagongrid: {

  ...
  public: {
    Tables: {
      ...
      rbs_admins: {
        ...
        Relationships: [
          {
            foreignKeyName: "rbs_admins_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "friends_view";
            referencedColumns: ["id"];
      ...
      restaurant_rating_requirements: {
        Row: {
          booking_policy_override: string | null;
          created_at: string | null;
          id: string;
          max_party_size_restricted: number | null;
          minimum_user_rating: number;
          restaurant_id: string;
        ...
        Relationships: [
          {
            foreignKeyName: "restaurant_rating_requirements_restaurant_id_fkey";
            columns: ["restaurant_id"];
            isOneToOne: false;
            referencedRelation: "restaurant_hours_summary";
            referencedColumns: ["restaurant_id"];
      ...
      restaurant_sections: {
        ...
        Relationships: [
          {
            foreignKeyName: "restaurant_sections_restaurant_id_fkey";
            columns: ["restaurant_id"];
            isOneToOne: false;
            referencedRelation: "restaurant_hours_summary";
            referencedColumns: ["restaurant_id"];
      ...
      staff_position_assignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_position_assignments_position_id_fkey";
            columns: ["position_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "staff_position_assignments_staff_id_fkey";
            columns: ["staff_id"];
            isOneToOne: false;
            referencedRelation: "restaurant_staff";
            referencedColumns: ["id"];
      ...
      staff_positions: {
        ...
        Relationships: [
          {
            foreignKeyName: "staff_positions_restaurant_id_fkey";
            columns: ["restaurant_id"];
            isOneToOne: false;
            referencedRelation: "restaurant_hours_summary";
            referencedColumns: ["restaurant_id"];
      ...
      time_clock_entries: {
        ...
        Relationships: [
          {
            foreignKeyName: "time_clock_entries_approved_by_fkey";
            columns: ["approved_by"];
            isOneToOne: false;
            referencedRelation: "friends_view";
            referencedColumns: ["id"];
    ...
    Views: {
      ...
      restaurant_monthly_analytics: {
        Row: {
          app_bookings: number | null;
          app_covers: number | null;
          manual_bookings: number | null;
          manual_covers: number | null;
          month: string | null;
          month_period: string | null;
          phone_bookings: number | null;
          phone_covers: number | null;
          restaurant_id: string | null;
          total_bookings: number | null;
          total_covers: number | null;
          walkin_bookings: number | null;
          walkin_covers: number | null;
          widget_bookings: number | null;
          widget_covers: number | null;
        };
        Relationships: [
          {
            foreignKeyName: "bookings_restaurant_id_fkey";
    ...
    Functions: {
      ...
      check_playlist_collaboration: {
        Args: { playlist_id_param: string; user_id_param: string };
        Returns: boolean;
      };
      ...
      convert_waitlist_to_booking: {
        Args: { p_staff_user_id: string; p_waitlist_id: string };
        Returns: string;
      };
      ...
      downgrade_restaurants_to_basic: {
        Args: { restaurant_ids: string[] };
        Returns: {
          new_booking_policy: string;
          new_tier: Database["public"]["Enums"]["tier"];
          old_booking_policy: string;
          old_tier: Database["public"]["Enums"]["tier"];
          restaurant_id: string;
      ...
      get_current_month_analytics: {
        ...
        Returns: {
          ...
          manual_covers: number;
          total_bookings: number;
          total_covers: number;
          widget_bookings: number;
          widget_covers: number;
        }[];
      };
      ...
      get_restaurant_shared_tables_summary: {
        Args: { restaurant_id_param: string; target_date?: string };
        Returns: {
          capacity: number;
      ...
      get_shared_table_available_seats: {
        Args: {
          ...
          table_id_param: string;
          turn_time_minutes_param?: number;
        };
        Returns: number;
      };
      ...
      get_user_notification_preferences: {
        Args: { p_user_id: string };
        Returns: Database["public"]["CompositeTypes"]["user_notification_prefs"];
      };
    ...
    CompositeTypes: {
      ...
      user_notification_prefs: {
        ...
        waitlist_position_updates: boolean | null;
        waitlist_expired: boolean | null;
        special_offers: boolean | null;
        loyalty_offers: boolean | null;
        expiring_offers: boolean | null;
        review_reminders: boolean | null;
        review_responses: boolean | null;
        review_featured: boolean | null;
        points_earned: boolean | null;
        milestone_reached: boolean | null;
        rewards_available: boolean | null;
        rewards_expiring: boolean | null;
        app_updates: boolean | null;
        maintenance_notices: boolean | null;

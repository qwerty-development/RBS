...
console.log('Minimum booking time (15 mins from now):', minimumBookingTime.toLocaleString());
...
console.log(`Difference: ${oldFilteredSlots.length - newFilteredSlots.length} slots filtered out by 15-min rule`);

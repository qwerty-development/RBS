...
const RewardCardSkeleton = () => (
  <View style={{ 
    ...
    {/* Description */}
    <SkeletonPlaceholder width="90%" height={16} borderRadius={4} style={{ marginTop: 12 }} />
    ...
    <View style={{ flexDirection: 'row', marginTop: 16 }}>
      ...
      <SkeletonPlaceholder width={80} height={24} borderRadius={12} style={{ marginLeft: 8 }} />
    </View>
  </View>
);
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#F5F5F5' }} edges={['top']}>
      ...
      <View style={{ padding: 16, borderBottomWidth: 1, borderBottomColor: '#E0E0E0' }}>
        ...
        <View style={{ alignItems: 'center' }}>
          <SkeletonPlaceholder width={100} height={32} borderRadius={4} style={{ marginBottom: 8 }} />
          <SkeletonPlaceholder width={200} height={16} borderRadius={4} style={{ marginBottom: 12 }} />

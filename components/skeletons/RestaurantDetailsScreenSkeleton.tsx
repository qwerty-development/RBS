  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        {/* Quick Actions */}
        <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#eee' }}>
        ...
        <View style={{ padding: 16 }}>
          <SkeletonPlaceholder width="80%" height={28} style={{ marginBottom: 8 }} />
        ...
        <View style={{ padding: 16, borderTopWidth: 1, borderTopColor: '#eee' }}>
          <SkeletonPlaceholder width="40%" height={22} style={{ marginBottom: 12 }} />
          <SkeletonPlaceholder width="100%" height={16} style={{ marginBottom: 6 }} />
          <SkeletonPlaceholder width="100%" height={16} style={{ marginBottom: 6 }} />
        ...
        {/* Reviews */}
        <View style={{ padding: 16, borderTopWidth: 1, borderTopColor: '#eee' }}>
          <SkeletonPlaceholder width="40%" height={22} style={{ marginBottom: 16 }} />
